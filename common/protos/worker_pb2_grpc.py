...
class WorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Infer = channel.unary_unary(
                '/worker.Worker/Infer',
                request_serializer=worker__pb2.InferRequest.SerializeToString,
                response_deserializer=worker__pb2.InferResponse.FromString,
...
def add_WorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Infer': grpc.unary_unary_rpc_method_handler(
                    servicer.Infer,
                    request_deserializer=worker__pb2.InferRequest.FromString,
                    response_serializer=worker__pb2.InferResponse.SerializeToString,
            ),
...
class Worker(object):
    ...
    def Infer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/worker.Worker/Infer',
            worker__pb2.InferRequest.SerializeToString,
            worker__pb2.InferResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
